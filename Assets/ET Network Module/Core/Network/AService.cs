...
namespace ET
{
    public abstract class AService : IDisposable
    {
        ...
        public long CreateConnectChannelId(uint localConn) => (--this.connectIdGenerater << 32) | localConn;
        public uint CreateRandomLocalConn() => (1u << 30) | RandomHelper.RandUInt32();
        // localConn放在低32bit
        private long acceptIdGenerater = 1;
        public long CreateAcceptChannelId(uint localConn) => (++this.acceptIdGenerater << 32) | localConn;
        ...
        public void SendStream(long channelId, long actorId, MemoryStream stream) => this.Send(channelId, actorId, stream);
