...
namespace ET
{
    ...
    public class ETTask : ICriticalNotifyCompletion
    {
        ...
        [DebuggerHidden]
        private async ETVoid InnerCoroutine() => await this;

        [DebuggerHidden]
        public void Coroutine() => InnerCoroutine().Coroutine();

        [DebuggerHidden]
        public ETTask GetAwaiter() => this;
        ...
        [DebuggerHidden]
        public void OnCompleted(Action action) => this.UnsafeOnCompleted(action);
    ...
    public class ETTask<T> : ICriticalNotifyCompletion
    {
        ...
        public void Coroutine() => InnerCoroutine().Coroutine();
        [DebuggerHidden]
        public ETTask<T> GetAwaiter() => this;
